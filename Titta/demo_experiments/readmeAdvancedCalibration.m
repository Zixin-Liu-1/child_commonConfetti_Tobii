...
try
    ...
    talkToProLab = TalkToProLab('Project32', '134.100.144.165'); % Project name ersetzen!
    ...
    [wpntP,winRectP] = PsychImaging('OpenWindow', scrParticipant, bgClr, [0 0 1920 1080], [], [], [], 4);
