...
% Uninstruct mode note
% --------------------
% When taskType is 'HamburgUninstruct', catch trials show the outcome
% confetti during the prediction phase (handled in al_mouseLoop) instead
% of revealing the cannon. The cannon is also suppressed in al_confetti.
% Outcomes are generated normally with variance — the fixed-outcome
% behaviour (outcome = distMean) only applies during the instruction phase,
% which is handled in the instruction wrapper, not here.
